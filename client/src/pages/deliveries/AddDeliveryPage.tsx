...
const AddDeliveryPage = () => {
	...
	return (
		<div className="min-h-screen flex flex-col justify-center items-center md:p-10 p-4">
			<div className="bg-zinc-900 rounded-2xl border-5 border-zinc-800 w-full max-w-137.5 flex flex-col">
				<div className="px-6 py-6 shrink-0">
					<h2 className="text-xl font-semibold tracking-tighter flex justify-center text-zinc-100">
						Create Delivery
					</h2>
				</div>
				...
				>
					<div className="space-y-4">
						...
						<div className="space-y-1.5">
							<label className="text-sm font-medium text-zinc-400 tracking-tight">
								Courier Name
							</label>
							<input
								type="text"
					...
					<div className="flex justify-end pt-4">
						<div className="w-full flex flex-col gap-2 justify-between items-center">
							...
							<button
								...
								className="w-full bg-emerald-700 text-sm flex justify-center tracking-tight items-center text-black font-medium py-2 rounded-full hover:bg-emerald-600 transition-colors shadow-sm cursor-pointer"
							>
